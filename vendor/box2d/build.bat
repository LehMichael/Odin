...
if /I "%VSCMD_ARG_TGT_ARCH%" == "arm64" (
	...
	call :build_one "build\windows-amd64-avx2" ON "lib\box2d_windows_amd64_avx2.lib"
	if errorlevel 1 goto :error
	call :build_one "build\windows-amd64-sse2" OFF "lib\box2d_windows_amd64_sse2.lib"
	if errorlevel 1 goto :error
)
